...
class PrometheusRule(BaseModel):
    ...
    for_duration: str = Field(description="Duration the condition must be true before alerting")
...
prompt = ChatPromptTemplate.from_messages([
    ("system", """You are an expert in creating Prometheus alert rules for Kubernetes services.
